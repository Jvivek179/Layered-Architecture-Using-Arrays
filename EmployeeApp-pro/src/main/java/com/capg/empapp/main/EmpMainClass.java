	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 6:
				...
				try {
					boolean isChanged = app.empService.editSalaryByEmployeeId(empIdSearch, empNewExp);
					if (isChanged) {
						System.out.println(" Employee Details Updated !!!");
					} else {
						throw new Exception("Cannot Find Employee ID...");
			...
			case 7:
				...
				Employee expsRange[] = app.empService.getEmployeeBySalaryRange(empExpmin, empExpmax);
			...
			case 8:
				...
				Employee exps[] = app.empService.getEmployeeBySalary(empExp1);
